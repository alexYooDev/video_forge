  ...
  async loadConfiguration() {
    ...
    try {
      ...
      for (const [envVar, secretPath] of Object.entries(mapping.secrets)) {
        ...
        apiLogger.system('Loaded secret', { envVar, status: secretValue ? 'SUCCESS' : 'FAILED' });
      ...
      for (const [envVar, paramPath] of Object.entries(mapping.parameters)) {
        ...
        apiLogger.system('Loaded parameter', { envVar, status: parameters[paramPath] ? 'SUCCESS' : 'FAILED' });
