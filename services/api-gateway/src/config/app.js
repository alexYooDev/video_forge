...
class App {
    ...
    setupRoutes() {
      ...
      this.app.get('/api/health', (_req, res) => {
        res.status(200).json({ status: 'OK', timestamp: new Date().toISOString(), service: 'api-gateway' });
      });
    ...
    async start() {
        ...
        this.app.listen(this.PORT, '0.0.0.0', () => {
            ...
            apiLogger.system('API Gateway running', { url: serverUrl, environment: this.config.environment });
        })
    }
